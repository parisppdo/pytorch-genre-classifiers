...
JSON_PATH = "../Mel Spectrogram Classifiers/backup data/data_full_3_segments.json"
...
def save_melspec(dataset_path,
                ...
                n_mels=128,
                n_fft=512,
                win_length=400, # This is proposed in this paper: https://www.mdpi.com/2227-7390/10/23/4427 (It usually is equal to n_fft)
                hop_length=160,
